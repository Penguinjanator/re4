    ...
    case 1:
        ...
        if (e->NowCut == 4) {
            if (e->NowFrame == 0) {
                ...
                EffectEspDelete(r325_work->tex[0]->mask | 0x3001, ESP_CORE_KIND_NONE, 0, 0);
                EffectEspgenDelete(r325_work->tex[0]->mask | 0x3001, ESP_CORE_KIND_NONE, 0);
                EffectEfmDelete(r325_work->tex[0]->mask | 0x3001, ESP_CORE_KIND_NONE, 0);
                EstSet(0, -1, 0, 0, EFF_ROOM, 0, r325_work->tex[0]->mask | 0x3001, ESP_CORE_KIND_NONE, 0, 0);
            }
        } else {
            if (e->NowFrame == 0) {
                if (e->GetMod(&mod, "pl0000", 0, 0) == 1) {
        ...
        if (e->NowCut == 7) {
            if (e->NowFrame == 0) {
                ...
                EffectEspDelete(r325_work->tex[1]->mask | 0x3001, ESP_CORE_KIND_NONE, 0, 0);
                EffectEspgenDelete(r325_work->tex[1]->mask | 0x3001, ESP_CORE_KIND_NONE, 0);
                EffectEfmDelete(r325_work->tex[1]->mask | 0x3001, ESP_CORE_KIND_NONE, 0);
                EstSet(0, -1, 0, 0, EFF_ROOM, 1, r325_work->tex[1]->mask | 0x3001, ESP_CORE_KIND_NONE, 0, 0);
            }
        } else {
            if (e->NowFrame == 0) {
                if (e->GetMod(&mod, "pl0000", 0, 0) == 1) {
