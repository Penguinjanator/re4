// OdemuExi2 debugger driver (Dolphin SDK OdemuExi2.a / DebuggerDriver.c).
// Source: mariopartyrd/partyboard src/OdemuExi2/DebuggerDriver.c (matching decompilation).
