/* newlib 1.8.2 libc/stdlib/mbtowc_r.c (MB_CAPABLE) */
...
typedef enum { ASCII, A_ESC, A_ESC_DL, JIS, JIS_1, JIS_2, J_ESC, J_ESC_BR, J2_ESC, J2_ESC_BR, DONE, INV, JIS_S_NUM } JIS_STATE;
