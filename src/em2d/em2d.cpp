...
void cEm2d::move()
{
    ...
    if (hp > 0 && type != 4) {
        ...
        if (n) {
            ...
            w->effTimer = Rnd() % 3 + 5;
            EstSet(this, -1, 0, 0, 0x25, 5, 0, 0, this, (void*) n);
        }
    }
    em2dEyeMove(this);
    em2dHumSeMove(this);
...
void em2dInitRtnSet(cEm2d* em)
{
    ...
    w->homePos = em->pos;
    if (em->type != 4) {
        EstSet(em, -1, 0, 0, 0x25, 4, 0, w->espKind, em, 0);
        if (em->type != 4) {
            EstSet(em, -1, 0, 0, 0x25, 0x10, 0, w->espKind2, em, 0);
        }
    }
    if (em->type == 4) {
        em->flag |= 0x40000000;
...
static void em2d_R1_AtkPoison(cEm2d* em)
{
    ...
    case 0:
        ...
        EstSet(em, -1, 0, 0, 0x25, 2, 0, 0, em, 0);
    ...
    case 1:
        ...
        if (em->seFlags28B & 1) {
            EstSet(em, -1, 0, 0, 0x25, 3, 0, 0, em, 0);
            em2dSetPoison(em, 0);
        }
        break;
    }
...
static void em2d_R1_JumpAtkHit(cEm2d* em)
{
    ...
    case 0:
        ...
        PlGachaInit();
        EstSet(em, -1, 0, 0, 0x25, 1, 0, 0, em, (void*) fe);
    ...
    case 6:
        ...
        w->timer8 = 45;
        EstSet(em, -1, 0, 0, 0x25, 6, 0, 0, em, 0);
        em->r_no_2++;
    case 7:
        em->setStatus(EM_STATUS_IK_OFF);
        MotionGetSpeed(em, &em->Motion, 0, &spd, &rot);
...
static void plem2d_JumpAtkHit(cPlayer* pl)
{
    ...
    case 0:
        ...
        pl->m_Work0 = 127;
        EstSet(pl, -1, 0, 0, 0x25, 0x13, 0, 0, pl, (void*) fe);
        pl->r_no_3 = Rnd() & 1;
        pl->m_Work0 = 10;
        pl->r_no_2++;
    case 1:
...
static void plem2d_JumpKickHit(cPlayer* pl)
{
    ...
    case 1:
        ...
        if (t) {
            ...
            PlSetDamage(8, 0, 0);
            EstSet(pl, -1, 0, 0, 0x25, 0x1A, 0, 0, pl, (void*) t);
        }
        break;
    }
    pl->x3A8 = pl->pos;
...
void em2dActEvtSetKick(cEm2d* em, int side)
{
    ...
    ActBtn.set(7, 0xB, (void*) em2dKickAction, em, 1, 1, 0, 0);
}
...
static void em2d_R1_W_AtkPoison(cEm2d* em)
{
    ...
    case 0:
        MotionSetCore(em, &em->Motion, ARC(0x46), 0, 10, 5, 0);
        EstSet(em, -1, 0, 0, 0x25, 7, 0, 0, em, (void*) fe);
        w->sndId = SndCall(8, 0x16, &em->pos, em->id, 0, em);
        w->timer = 30;
        em->r_no_2++;
    case 1:
    ...
    case 3:
        ...
        if (end) {
            ...
            EstSet(em, -1, 0, 0, 0x25, 9, 0, 0, em, (void*) end);
            em2dSetPoison(em, 1);
        }
        break;
    }
...
static void em2d_R1_Dm_Blow(cEm2d* em)
{
    ...
    case 0:
        ...
        if ((w->flags & 0x80000) && (pG->room_id == 0x205 || pG->room_id == 0x21D)) {
            EstSet(em, -1, 0, 0, 1, 0x16, 0, 0, em, 0);
        }
        w->flags |= 0x4000;
        em->r_no_2++;
    case 1:
...
static void em2d_R1_Die_Lost(cEm2d* em)
{
    ...
    case 0:
        ...
        if (ChkWaterEffectEnable(&em->pos)) {
            EstSet(em, -1, 0, 0, 0x25, 0x21, 0, 0, em, (void*) fe);
        } else {
            EstSet(em, -1, 0, 0, 0x25, 0x2A, 0, 0, em, 0);
        }
        w->timer = 30;
        w->timer8 = 150;
        w->Compress_y = 1.0f;
...
int em2dAtkCk(cEm2d* em, int no, int parts)
{
    ...
    if (hit & 1) {
        ...
        case 2:
            ...
            EstSet(pPL, -1, 0, 0, 0x25, 0x26, 0, 0, pPL, 0);
            pG->pl_life = 0;
...
void em2dPlHeadLost()
{
    ...
    if (pSys->eff_country == 0) {
        PlSetDamageSe(0xD);
        EstSet(pPL, -1, 0, 0, 0x25, 0x2C, 0, 0, pPL, 0);
        return;
    }
    zero = 0;
    SndCall(1, 0x3E, &pPL->pos, 0, 0, pPL);
    EstSet(pPL, -1, 0, 0, 0x25, 0x2D, 0, 0, pPL, (void*) zero);
    pPL->setHead(0);
    ...
    EstSet(obj, -1, 0, 0, 0x25, 0x2E, 0, 0, obj, (void*) zero);
}
...
void em2dEyeMove(cEm2d* em)
{
    ...
    switch (w->x535) {
    case 1:
        EstSet(em, -1, 0, 0, 0x25, 0x12, 0, 0, em, 0);
        break;
    case 2:
        EstSet(em, -1, 0, 0, 0x25, 0x11, 0, 0, em, 0);
        break;
    }
    w->x535 = st;
    switch (st) {
    case 1:
        ...
        break;
    case 2:
        EstSet(em, -1, 0, 0, 0x25, 0xF, 0, w->espKind2, em, 0);
        break;
    }
}
...
void em2dHumSeMove(cEm2d* em)
{
    ...
    if (!(w->flags & 0x100000)) {
        EstSet(em, -1, 0, 0, 0x25, 0x27, 0, w->espKind3, em, 0);
        w->flags |= 0x100000;
    }
    if (w->x534) {
        w->x534--;
