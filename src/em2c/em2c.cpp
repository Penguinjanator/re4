...
static void em2c_R1_C_Wait(cEm2c* em)
{
    ...
    case 3:
        ...
        if (w->timer > 17) {
            ...
            ActBtn.set(0x13, 0xB, (void*) em2cSitAction, em, 1, 4, 0, w->x6B8);
        }
        if (w->timer) {
            w->timer--;
        } else {
    ...
    case 5:
        ...
        if (w->timer) {
            w->timer--;
            if (w->x6B8 == 0) {
                ActBtn.set(0x25, 0xB, (void*) em2cBackjumpAction, em, 1, 4, 0, w->x6B8);
            }
        }
        if (em->seFlags28B & 1) {
            em2cAtkCk(em, 4, 0xB);
...
static void em2c_R1_T_Wait(cEm2c* em)
{
    ...
    case 3:
        ...
        if (w->timer > 17) {
            ...
            ActBtn.set(0x25, 0xB, (void*) em2cBackjumpAction, em, 1, 3, 0, w->x6B8);
        }
        if (em->r_no_3) {
