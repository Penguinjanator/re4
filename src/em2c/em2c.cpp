        ...
        if (w->walkMode) {
            ...
            if (hit == 0) {
                ...
                if (fabsf(Muku(&pPLS->pos, &em->pos, pPLS->ang.y, 3.14159274f)) < 1.04719758f) {
                    ActBtn.set(0x25, 0xB, (void*) em2cEscapeAction, em, 1, 3, 0, hit);
                } else {
                    ActBtn.set(0x13, 0xB, (void*) em2cSitAction, em, 1, 3, 0, hit);
                }
            }
        }
        if (w->timer) {
    ...
    case 1:
        ...
        if (w->timer < w->timer8) {
            if (w->actDone == 0) {
                if (em->r_no_3 == 0) {
                    if (w->mode) {
                        ActBtn.set(0x25, 0xB, (void*) em2cBackjumpAction2, em, 2, 3, 0, em->r_no_3);
                    } else {
                        ActBtn.set(0x13, 0xB, (void*) em2cSitAction, em, 2, 4, 0, w->mode);
                    }
                }
            } else {
                w->timer = 0;
    ...
    case 3:
        ...
        if (w->timer) {
            ...
            if (w->actDone == 0 && em->r_no_3 == 0) {
                ActBtn.set(0x13, 0xB, (void*) em2cSitAction, em, 2, 4, 0, em->r_no_3);
            }
        }
        if (em->seFlags28B & 1) {
            em2cAtkCk(em, 4, 0xB);
...
static void em2c_R1_C_Wait(cEm2c* em)
{
    ...
    case 3:
        ...
        if (w->timer > 17) {
            ...
            ActBtn.set(0x13, 0xB, (void*) em2cSitAction, em, 1, 4, 0, w->actDone);
        }
        if (w->timer) {
            w->timer--;
        } else {
    ...
    case 5:
        ...
        if (w->timer) {
            w->timer--;
            if (w->actDone == 0) {
                ActBtn.set(0x25, 0xB, (void*) em2cBackjumpAction, em, 1, 4, 0, w->actDone);
            }
        }
        if (em->seFlags28B & 1) {
            em2cAtkCk(em, 4, 0xB);
...
static void em2c_R1_T_Wait(cEm2c* em)
{
    ...
    case 3:
        ...
        if (w->timer > 17) {
            ...
            ActBtn.set(0x25, 0xB, (void*) em2cBackjumpAction, em, 1, 3, 0, w->actDone);
        }
        if (em->r_no_3) {
    ...
    case 1:
        ...
        if (em->plDist2 < 2250000.0f) {
            ...
            if (hit == 0 && fabsf(Muku(&pPL->pos, &em->pos, pPL->ang.y, 3.14159274f)) < 0.785398185f) {
                ActBtn.set(7, 0xB, (void*) em2cKickAction, em, 1, 1, 0, hit);
            }
        }
        break;
    }
