...
void cEm31::move()
{
    ...
    if (type == 0) {
        ...
        if (hp > 0) {
            EstSet(this, -1, 0, 0, 0x29, 0x1D, 0, 0, this, 0);
        }
    }
    em31TailAtkCk(this);
    em31FootSe(this);
...
static void em31_R1_Appear(cEm31* em)
{
    ...
    case 2:
        ...
        EstSet(em, -1, 0, 0, 0x29, 0x26, 1, w->EffKindId, em, 0);
        em->r_no_2++;
    case 3:
...
static void em31_R1_Jump(cEm31* em)
{
    ...
    case 0:
        ...
        EstSet(em, -1, 0, 0, 0x29, 0x18, 0, 0, em, 0);
        w->Atk_ck = 0;
        em->r_no_2++;
    case 1:
        if (em->motEvent & 2) {
...
static void em31_R1_Catch(cEm31* em)
{
    ...
    case 0:
        ...
        EstSet(em, -1, 0, 0, 0x29, 0x20, 0, 0, em, 0);
        if (w->pTen) {
            w->pTen->setCatch();
        }
        em->r_no_2++;
...
#define PLEM31_CATCH_HIT_SUB(mot, est)                                                                  \
    ...
    case 0:                                                                                         \
        ...
        PlSetFace(1);                                                                               \
        EstSet(pl, -1, 0, 0, 0x29, est, 0, 0, pl, 0);                                   \
...
static void em31_R1_T_Appear(cEm31* em)
{
    ...
    case 2:
        MotionSetCore(em, MOTION(em), ARC(0x5C), 0, 0, 1, 0);
        EstSet(em, -1, 0, 0, 0x29, 0x24, 1, w->EffKindId, em, 0);
        EstSet(0, -1, 0, 0, 0x29, 0x25, 1, w->EffKindId, em, 0);
        em->setStatus(EM_STATUS_ACTIVE);
        em->r_no_2++;
    case 3:
        if (MotionMove(em, 0)) {
...
static void em31_R1_T_Atk(cEm31* em)
{
    ...
    case 0:
        ...
        EstSet(em, -1, 0, 0, 0x29, 0x1A, 0, 0, em, 0);
        em->setVoice(0x19, 2);
        w->Atk_ck = 0;
        em->r_no_2++;
    case 1:
...
static void em31_R1_T_Down(cEm31* em)
{
    ...
    case 3:
        if (w->Timer % 3 == 0) {
            EstSet(em, -1, 0, 0, 0x29, 0x17, 0, 0, em, 0);
        }
        w->Timer++;
        MotionMove(em, 0);
        if (em->flag & 1) {
    ...
    case 4:
        ...
        if (w->Be_flg & 0x2000) {
            EstSet(em, -1, 0, 0, 0x29, 0x16, 0, 0, em, 0);
        }
        em31WeakMode(em, 0);
        em->r_no_2++;
    case 5:
...
static void em31_R1_T_Dm_Climb(cEm31* em)
{
    ...
    case 2:
        ...
        EstSet(em, -1, 0, 0, 0x29, 0x30, 0, 0, em, 0);
        em->r_no_2++;
    case 3:
        if (MotionMove(em, 0)) {
            em->r_no_2++;
    ...
    case 4:
        ...
        em31WeakMode(em, 0);
        EstSet(em, -1, 0, 0, 0x29, 0x35, 0, 0, em, 0);
        em->setVoice(0x37, 2);
        em->r_no_2++;
    case 5:
        if (MotionMove(em, 0)) {
...
static void plem31_Climb(cPlayer* pl)
{
    ...
    case 2:
        ...
        if (em31CatchObj.p) {
            ...
            EstSet(pl, -1, 0, 0, 0x29, 0x31, 0, 0, pl, 0);
        }
        pl->r_no_2++;
    case 3:
        if (MotionMove(pl, 0)) {
...
static void em31_R1_Die_Normal(cEm31* em)
{
    ...
    case 2:
        ...
        EM31_TAIL_CLEAR();
        if (w->Be_flg & 0x800) {
            EstSet(em, -1, 0, 0, 0x29, 0x2A, 1, w->EffKindId, em, 0);
            EstSet(em, -1, 0, 0, 0x29, 0x2D, 1, w->EffKindId, em, 0);
            if (w->pTen) {
                EstSet(w->pTen, -1, 0, 0, 0x29, 0x32, 1, w->EffKindId, em, 0);
            }
        } else {
            EstSet(em, -1, 0, 0, 0x29, 0x2E, 1, w->EffKindId, em, 0);
            if (w->pTen) {
                EstSet(w->pTen, -1, 0, 0, 0x29, 0x2F, 1, w->EffKindId, em, 0);
            }
        }
        w->Timer = 90;
        em->r_no_2++;
...
static inline void em31PlCrush(cEm31* em)
{
    if ((s16) pG->pl_life <= 0) {
        ...
        EstSet(pPL, -1, 0, 0, 0x29, 0x1B, 0, 0, pPL, 0);
        EstSet(em, -1, 0, 0, 0x29, 0x1C, 0, 0, em, 0);
    }
}
...
static void plem31_dm_Stamp(cPlayer* pl)
{
    ...
    case 0:
        ...
        case 0:
        default:
            EstSet(pl, -1, 0, 0, 0x29, 0x1E, 0, 0, pl, 0);
            break;
        case 1:
            EstSet(pl, -1, 0, 0, 0x29, 0x1F, 0, 0, pl, 0);
            break;
        case 2:
            break;
        }
...
void em31BloodSet(cEm31* em)
{
    ...
    if (em31EyelidDmcK(em, 0)) {
        kind = 2;
        if (part == &w->hit[0]) {
            EstSet(em, -1, 0, 0, 0x29, 0x12, 0, 0, em, 0);
        }
        if (part == &w->hit[1]) {
            EstSet(em, -1, 0, 0, 0x29, 0x13, 0, 0, em, 0);
        }
        if (part == &w->hit[2]) {
            EstSet(em, -1, 0, 0, 0x29, 0x14, 0, 0, em, 0);
        }
        if (part == &w->hit[3]) {
            EstSet(em, -1, 0, 0, 0x29, 0x15, 0, 0, em, 0);
        }
    }
    switch ((u32) kind) {
    case 0:
...
void em31PlHeadLost()
{
    ...
    if (pSys->eff_country == 0) {
        PlSetDamageSe(0xD);
        EstSet(pPL, -1, 0, 0, 0x29, 0x29, 0, 0, pPL, 0);
        return;
    }
    SndCall(1, 0x3E, &pPL->pos, 0, 0, pPL);
    EstSet(pPL, -1, 0, 0, 0x29, 0x27, 0, 0, pPL, 0);
    pPL->setHead(0);
    p = pPL->getPartsPtr(3);
    if (pG->pl_type == 2) {
        ofs.x = 0.0f;
    ...
    EstSet(obj, -1, 0, 0, 0x29, 0x28, 0, 0, obj, 0);
}
