...
// Work of the em28 enemy (em28 module, D:/Bio4/Prog/em28.cpp: the crow), overlaid on cEm from 0x3E0.
struct Em28Work {
    ...
    int stuckCnt;         // 0x160 (0x540)  frames the crow moved less than half its speed
