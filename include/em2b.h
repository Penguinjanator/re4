...
struct Em2bWork {
    u32 flags;            // 0x000 (0x3E0)  bit0: route found, bit2: targets the partner, bit3: damage / die routine, bit4: routine running,
    ...
    cCtrl* pCtrl12;       // 0x27C (0x65C)  GetCtrlCtrl12()
    cModelInfo* pInfo;    // 0x280 (0x660)
    TexRenderMng* pTex;   // 0x284 (0x664)  Ctrl12GetTexRenderEm2b (room 224)
    u8 texBlend[8];       // 0x288 (0x668)  cModelInfo::setTexBlendTbl table (em2b_R1_HoleAtk)
    u8 pad_290[0x18];
    f32 blendVal;         // 0x2A8 (0x688)
    ...
    cObj* pObj4C8;        // 0x4C8 (0x8A8)
    cObj* pObj4CC;        // 0x4CC (0x8AC)
    cObj16* pParasite;    // 0x4D0 (0x8B0)
    cObj16* pTentacle[10]; // 0x4D4 (0x8B4)  face tentacles of the parasite (em2bSetTentacle)
    cObjYagura* pYagura;  // 0x4FC (0x8DC)  the tower shaken by the base attack (em2bYaguraSearch)
    cEmTree* pTree;       // 0x500 (0x8E0)  tree held
    cEmTree* pTreeLost;   // 0x504 (0x8E4)
    cEm* pTarget508;      // 0x508 (0x8E8)
    ...
    int dmgTotal;         // 0x610 (0x9F0)
    int timer614;         // 0x614 (0x9F4)
    int timer618;         // 0x618 (0x9F8)
    int timer61C;         // 0x61C (0x9FC)
    int timer620;         // 0x620 (0xA00)
    int timer624;         // 0x624 (0xA04)
    int timer628;         // 0x628 (0xA08)
    int timer62C;         // 0x62C (0xA0C)
    int paraHp;           // 0x630 (0xA10)
    u32 stuckCnt;         // 0x634 (0xA14)
    int dmGuard;          // 0x638 (0xA18)
    int x63C;             // 0x63C (0xA1C)
    int x640;             // 0x640 (0xA20)
    f32 scaleRate;        // 0x644 (0xA24)
    u8 espKind;           // 0x648 (0xA28)
    u8 atkHit;            // 0x649 (0xA29)
    u8 variant;           // 0x64A (0xA2A)
    u8 atkBtn;            // 0x64B (0xA2B)  parasite attack button: 1 = 0x40000, 0 = 0x80000 (Key.trg)
    u8 espKind2;          // 0x64C (0xA2C)
    u8 debugAtk;          // 0x64D (0xA2D)
};
