...
// Flag bit indices, named as the flag editor (game/t_flag.cpp) names them. A word holds its first
// flag in bit 31, so index n of a word is 0x80000000 >> n; the Chk macros below shift the bit to the
// sign and test that, which is one signed compare for index 0 and a mask test for the rest.
