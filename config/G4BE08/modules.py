...
MATCHING = {
    ...
    "t_movie/snd_test.cpp": True,  # disp_sequencer: `int y0 = 0x54` single-set REG_EQUIV constant ahead of `ch = 0` (one more preheader filler in LUID order), `y = y0 + 0x54` after the D diamond; pure C
